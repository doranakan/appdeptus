...
const config = createConfig({
  ...
  components: {
    ...GSConfig.components,
    Button: {
      ...GSConfig.components.Button,
      theme: {
        ...GSConfig.components.Button.theme,
        ':disabled': {
          opacity: '$60'
        },
        borderRadius: '$none',
        variants: {
          ...
          action: {
            ...GSConfig.components.Button.theme.variants.action,
            negative: {
              _text: {
                color: '$white'
              },
    ...
    Pressable: {
      ...
      theme: {
        ...GSConfig.components.Pressable.theme,
        ':active': {
          opacity: '$80'
        },
        ':disabled': {
