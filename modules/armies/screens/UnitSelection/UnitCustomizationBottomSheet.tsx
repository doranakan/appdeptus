            ...
            >
                ...
                <VStack space='md'>
                  {selectedUnit.tiers.map((newTier) => (
                    <Pressable
                      ...
                      className={clsx(
                        unit.tier.id !== newTier.id && 'opacity-60'
                      )}
                      key={newTier.id}
                      onPress={() => {
              ...
              {selectedUnit.upgrades.length ? (
                <VStack space='sm'>
                  ...
                  <VStack space='md'>
                    {selectedUnit.upgrades.map(
                      ({ id, name, points, maxQuantity, quantityMode }) => {
                        const currentQty = unit.upgrades.filter(
                          ({ id: sid }) => sid === id
                        ).length
                                ...
                                onPress={() => {
                                  ...
                                  setValue(
                                    ...
                                    units.map((u) => {
                                      ...
                                      const idx = upgrades.findLastIndex(
                                        ({ id: sid }) => sid === id
                                      )
                                      if (idx !== -1) {
