...
const inputFieldStyle = tva({
  base: 'py-auto ios:leading-[0px] h-full flex-1 px-3 text-typography-900 placeholder:text-typography-500 web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
